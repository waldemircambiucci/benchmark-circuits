...
sx q[2];
rz(4.62709239263586) q[2];
sx q[2];
rz(7.677827217210477) q[2];
rz(pi/4) q[2];
rz(-pi) q[3];
sx q[3];
rz(0.03700584379371907) q[3];
...
cx q[10],q[8];
rz(pi/16) q[11];
rz(1.6308479347322518) q[11];
sx q[11];
rz(2*pi) q[11];
sx q[11];
rz(10.93552267962692) q[11];
cx q[11],q[1];
rz(0) q[1];
sx q[1];
