...
cx q[1],q[8];
rz(0.9323396817986103) q[1];
sx q[1];
rz(5.823295699283944) q[1];
sx q[1];
rz(6.578162535820045) q[1];
rz(pi/2) q[1];
sx q[1];
rz(pi/2) q[1];
cx q[11],q[1];
...
rz(3*pi) q[10];
cx q[10],q[0];
rz(-1.5406999067400287) q[0];
sx q[0];
rz(3.551326361734937) q[0];
sx q[0];
rz(11.982111185864758) q[0];
rz(1.7162092772963238) q[10];
sx q[10];
rz(2*pi) q[10];
sx q[10];
rz(8.784792747873357) q[10];
rz(pi/16) q[6];
rz(pi/2) q[6];
sx q[6];
